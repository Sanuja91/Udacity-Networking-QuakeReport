...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<List<Earthquake>> {
    ...
    // Base URI to USGS site to query and receive JSON Response from
    ...
    // Creates Menu Bar within Activity
    @Override
    ...
    // Opens Menu Bar when Icon is selected
    @Override
    ...
    // Creates a New Earthquake Loader
    @Override
    public Loader<List<Earthquake>> onCreateLoader(int i, Bundle bundle) {
        Log.v("Loader", "Creating Loader");

        // Getting relevant information from the settings tab
